...
5. Follow `docs/10_implementation/agent_execution_protocol.md`; verify with `pwsh -NoProfile -File scripts/verify.ps1` (PowerShell 7 on Linux or Windows; created by IMP-000). CI runs on GitHub-hosted Linux + Windows runners (ADR-0058).
