...
5. Follow `docs/10_implementation/agent_execution_protocol.md`; verify with `powershell -NoProfile -ExecutionPolicy Bypass -File scripts/verify.ps1` (Windows only; created by IMP-000).
